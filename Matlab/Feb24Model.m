...
offsets4 = [9.5 10.5 11.5 12.5 13.5 14.5 15.5 16.5 17.5];
...
for i = 1:11
    ...
    title('Transect 1 (5 on bottom, 15 on top)')
    xlabel('wavenumber')
    hold on
end
xlim([175 3200])
...
for i = 1:8
    ...
    title('Transect 2 (16 on bottom, 23 on top)')
    xlabel('wavenumber')
    hold on
end
xlim([175 3200])
...
for i = 1:5
    ...
    title('Transect 3 (24 on bottom, 28 on top)')
    xlabel('wavenumber') 
    hold on
end
xlim([175 3200])
...
for i = 1:9
    ...
    title('Transect 4 (29 on bottom, 37 on top)')
    xlabel('wavenumber')
    hold on
end
xlim([175 3200])
