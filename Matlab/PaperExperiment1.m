...
plot(wavenumbers_1, havg_1);
plot(wavenumbers_1, tavg_1);
xlim([250 3200])
title('Avg. Corr. & Normalized Spectra; ex=1064nm; n=27 healthy, 28 neoplasia; time=10sec, scans=3')
...
xlim([250 3200])
title('Avg. Corr. & Normalized Spectra; ex=785nm; n=24 healthy, 19 neoplasia; time=10sec, scans=1')
ylabel('Rel. Intensity (arb. units)')
xlabel('Wavenumber cm^-^1')
